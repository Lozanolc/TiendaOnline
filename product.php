       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1 style="text-align: center;"><b><i>Productos Disponibles</i></b></h1>
            </div>
            <?php
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-xs-12 col-md-4">
                    <div class="dropdown">
                      <button class="btn btn-primary btn-raised dropdown-toggle" type="button" id="drpdowncategory" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><b>
                      ...
                      <ul class="dropdown-menu" aria-labelledby="drpdowncategory">
                        <?php 
                          while($cate=mysqli_fetch_array($checkAllCat, MYSQLI_ASSOC)){
                              echo '
                                <li><b><a href="product.php?categ='.$cate['CodigoCat'].'">'.$cate['Nombre'].'</a></b></li>
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <span class="input-group-btn">
                              <button class="btn btn-info btn-raised" type="submit"><b>Buscar</b></button>
                          </span>
                        </div>
                      </div>
                    </form>
            ...
            ?>
              <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                         <div class="thumbnail">
                           ...
                           <div class="caption">
                             ...
                             <?php endif; ?>
                             <p class="text-center">
                                 <a href="infoProd.php?CodigoProd=<?php echo $prod['CodigoProd']; ?>" class="btn btn-primary btn-raised btn-sm btn-block">&nbsp; Ver Producto</a>
                             </p>
                ...
                <?php
                    ...
                    echo '<h2 class="text-center">No hay productos registrados en la categoría<strong>"'.$datCat['Nombre'].'"</strong></h2>';
                  }
                ?>
              </div>
            <?php
                }else{
                  echo '<h2 class="text-center">Seleccione una categoría</h2>';
                }
              else:
