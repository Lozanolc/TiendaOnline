...
<ul class="breadcrumb" style="margin-bottom: 5px;">
    <li>
        <a href="configAdmin.php?view=provider">
            <i class="fa fa-plus-circle" aria-hidden="true"></i> &nbsp; Nuevo Proveedor</a>
    </li>
    <li>
		...
		<div class="col-xs-12">
            <div class="container-form-admin">
                ...
                <form action="process/regprove.php" method="POST" class="FormCatElec" data-form="save">
                    ...
                    <p class="text-center"><button type="submit" class="btn btn-primary btn-raised"><b>Agregar proveedor</b></button></p>
                </form>
            </div>
        </div>
	</div>
