                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                ...
                                <input type="text" class="form-control" required maxlength="40" name="prod-name">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label">Costo de Instalación y Prueba</label>
                                <input type="number" class="form-control" required maxlength="2" pattern="[0-9]{1,2}" name="prod-desc-price" value="0">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label">Unidades disponibles</label>
                                <input type="number" class="form-control" required maxlength="20" pattern="[0-9]{1,20}" name="prod-stock">
                              </div>
                            </div>
                            <div class="col-xs-12">
                                <legend>Categoría, proveedor y condicion de pago</legend>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group">
                                <label>Mercancia se adquiere</label>
                                <select class="form-control" name="prod-estado">
                                    <option value="Activo" selected="">De contado</option>
                                    <option value="Desactivado">Dias Credito</option>
                                </select>
                              </div>
                            </div>
                            <div class="col-xs-12">
