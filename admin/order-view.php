  ...
  <div class="row">
        <div class="col-xs-12">
            ...
            <div class="panel panel-info">
                <div class="panel-heading text-center"><h4><b><u>Pedidos de la tienda</b></u></h4></div>
                    ...
                    <table class="table table-striped table-hover">
                        <thead class="">
                            <tr>
                              <th class="text-center">#</th>
                                ...
                                <th class="text-center">Contacto de Cliente</th>
                        ...
                        <tbody>
                            ...
                            <td style="text-align: center;">
                                <?php 
                                    $conUs= ejecutarSQL::consultar("SELECT Nombre, NIT, Telefono, Email FROM cliente WHERE NIT='".$order['NIT']."'");
                            ...
                            <td class="text-center">
                              <form action="process/delPedido.php" method="POST" class="FormCatElec" data-form="delete">
                                ...
                                <button type="submit" class="btn btn-raised btn-xs btn-danger">Vendido</button>  
                              </form>
                            </td>
                            </tr>
                            <?php
