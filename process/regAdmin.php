...
if(mysqli_num_rows($verificar)<=0){
    if(consultasSQL::InsertSQL("administrador", "Nombre, Clave", "'$nameAdmin','$passAdminFinal'")){
        echo '<script>
            swal({
              title: "El administrador se registró con éxito",
              type: "success",
    ...
    echo '<script>swal("ERROR", "El nombre que acaba de ingresar ya se encuentra registrado, por favor elija otro", "error");</script>';
}