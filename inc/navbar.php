...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            <div class="col-xs-4">
                <p class="text-navbar tittles-pages-logo"><img src="./assets/img/MArilexys.png" width="48px"> <b><i>Inversiones y Servicios</b></i></p>
            </div>
            <div class="col-xs-8">
              <div class="contenedor-tabla pull-right">
                <div class="contenedor-tr">
                  <a href="index.php" class="table-cell-td" style="font-size: large"><b><i>Inicio</i></b></a>
                  <a href="product.php?categ=002" class="table-cell-td" style="font-size: large"><b><i>Categorias</i></b></a> <!--Aqui decides que muestra la opcion de categoridas-->
                  <?php
                      if(!$_SESSION['nombreAdmin']==""){
                          echo ' 
                              <a href="carrito.php" class="table-cell-td" style="font-size: large"><b><i>Carrito</i></b></a>
                              <a href="configAdmin.php" class="table-cell-td" style="font-size: large"><b><i>Administración</i></b></a>
                              <a href="#!" class="table-cell-td exit-system">
                                  <i class="fa fa-user" style="font-size: large"></i>&nbsp;&nbsp;<b>Cerrar Sesion</b>
                              </a>
                              <a href="./report/pdf/ManualUsuarioAdministrador.pdf" target="_blank" class="table-cell-td" style="font-size: large"><b><i>Ayuda</i></b></a>
                           ';
                      }else if(!$_SESSION['nombreUser']==""){
                          echo ' 

                              <a href="pedido.php" class="table-cell-td" style="font-size: large"><b><i>Pedido</i></b></a>
                              <a href="carrito.php" class="table-cell-td" style="font-size: large"><b><i>Carrito</i></b></a>
                              <a href="./report/pdf/ManualUsuarioRegistrado.pdf" target="_blank" class="table-cell-td" style="font-size: large"><b><i>Dudas Frecuentes</i></b></a>
                              <a href="#!" class="table-cell-td exit-system" style="font-size: large">
                              &nbsp;&nbsp;<b>Salir</b>
                              </a>
                          ...
                          echo ' 
                          <a href="registration.php" class="table-cell-td" style="font-size: large"><b><i>Registro</i></b></a>
                          <a href="./report/pdf/usuarioNoRegistrado.pdf" target="_blank" class="table-cell-td" style="font-size: large"><b><i>Dudas Frecuentes</i></b></a>
                              <a href="#" class="table-cell-td" data-toggle="modal" data-target=".modal-login" style="font-size: large">
   ...
   <!-- Ventana de Inicio de Sesión -->
      ...
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login" style="padding: 15px;">
            <div class="modal-header">
              ...
              <img src="./assets/img/MArilexys.png" style="width: 98%">
              </p>
            </div>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">Tienda HM</h3>
        ...
        <ul class="list-unstyled text-center">
            ...
            <?php 
                if(!$_SESSION['nombreAdmin']==""){
                    echo '<li><a href="configAdmin.php?view=productlist">Administración</a></li>';
