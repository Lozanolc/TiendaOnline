    ...
    <section id="store">
       <br>
        <div class="container">
            ...
            <h1><b><i>Busqueda de productos</i></b></h1>
            </div>
                ...
                <div class="row">
                  <?php
                    ...
                    if(mysqli_num_rows($consultar_productos)>=1){
                      echo '<div class="col-xs-12"><h3 class="text-center">Se muestran las <strong>'.$search.' </strong>disponibles</h3><br><br></div>';
                  ...
                  <?php
                      ...
                      echo '<h2 class="text-center">Por el momento no contamos con <strong>'.$search.' </strong>disponibles<h2 class="text-center"><img src="./assets/img/MArilexys.png" width="350px"></h2></h2>';
                    }
                  ?>
                </div>
              </div>
            <?php
                  ...
                  echo '<h2 class="text-center">Ingrese el producto que desea buscar</h2>';
              }
            ?>
        </div>
    </section>
